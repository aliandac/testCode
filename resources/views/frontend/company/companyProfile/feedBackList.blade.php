...
@section('meta')
    ...
    <link rel="stylesheet" href="{{asset('css/companyFeedBacks/feedBacks.css')}}">
@endsection
<style>
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-md-push-3">
                <div class="page-content company-profile">
                   ...
                   <div class="col-md-12">
                        <div class="row">
                            @foreach($company->FeedBackList as $feedBack )
                                <div class="col-md-6 col-sm-6 col-6-style" >
                                    <div class="row">
                                        <div class="col-md-12 message-title-up">
                                            <span class="message-title">{{ $feedBack->messageTitle }}</span>
                                        </div>
                                        <div class="col-md-12 message-company-name-up" >
                                            <span class=" message-company-name   "> {{ $feedBack->companyName }}</span>
                                        </div>
                                        <div class="col-md-12 message-content" >
                                            {{ $feedBack->message }}
                                        </div>
                                        <div class="col-md-12 message-button-up" >
                                            <a href="{{ route('CompanyFeedBackDetail',['slug'=>Str::slug($feedBack->companyName),'id'=>$feedBack->id]) }}" title="{{ $feedBack->companyName }}" class="message-button">Devamını
                                                Oku...</a>
                                        </div>
                                    </div>
                                </div>
