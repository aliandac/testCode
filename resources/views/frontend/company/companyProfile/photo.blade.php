                    ...
                    <div class="company-profile company-contact" style="    background-color: #f3f3f3f3; margin-top: 15px;">
                        @if($companyImages->count() > 0)
                            ...
                            @foreach($companyImages as $image)
                                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-6 image">
                            ...
                            @endforeach
                                ...
                                @else
                                    <div class="col-md-12" style="text-align: center; padding-top: 40px;">
                                        <span style="font-size: 25px;  font-weight: bold;">Firmanın Resmlerini Görmek İstediğinizi Firmaya Bildirin </span>
