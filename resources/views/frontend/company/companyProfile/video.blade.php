                ...
                <div class="page-content company-profile">
                    ...
                    <div class="company-profile company-contact" style="    background-color: #f3f3f3f3; margin-top: 15px;">
                        <div class="company-video">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    @if($company->video_url != null or $companyVideo != null)
                                    <p>
                                        <a target="_blank" href="{!! $company->video_url !!}" title="Videoya Git" style="padding:1%;border:1px solid blue;">Videoya Git</a>
                                    </p>
                                    @foreach($companyVideo as $item)
                                        <div class="col-md-6 col-sm-6 col-xs-12" style="padding-top: 10px; padding-bottom: 10px">
                                    ...
                                    @else
                                        <div class="col-md-12" style="text-align: center; padding-top: 40px;">
                                            <span style="font-size: 25px;  font-weight: bold;">Firmanın Videolarını Görmek İstediğinizi Firmaya Bildirin </span>
