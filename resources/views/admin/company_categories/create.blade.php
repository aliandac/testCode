...
<div class="row">
    <div class="col-lg-12">
        <div class="kt-portlet">
            ...
            <form class="kt-form" method="post" action="{{route('category.store')}}" enctype="multipart/form-data">
            @csrf
                <div class="kt-portlet__body">
                    <div class="kt-section kt-section--first">
                        <div class="form-group">
                            <label>Kategori Adı :</label>
                            <input type="text" class="form-control" name="name" id="select"  value="{{old('name')}}">
                        </div>
                    </div>
                    <div class="kt-section kt-section--first">
                        <div class="form-group">
                    ...
                    <div class="kt-section kt-section--first">
                        <div class="form-group">
                            <label>Seo Url :</label>
                            <input type="text" class="form-control" name="seo_url" id="seo_url"  value="{{old('seo_url')}}">
                        </div>
                    </div>
                    <div class="kt-section kt-section--first">
                        <div class="form-group">
                    ...
                    <div class="kt-section kt-section--first">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="virtual_title" id="virtual_title"  value="{{old('virtual_title')}}">
                        </div>
                    </div>
                    <div class="kt-section kt-section--first">
                        <div class="form-group">
                    ...
                    <div class="kt-section kt-section--first">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="virtual_back_title" id="virtual_back_title"  value="{{old('virtual_back_title')}}">
                        </div>
                    </div>
                    <div class="kt-section kt-section--first">
                        <div class="form-group">
                            <label> Sanal Fuar Slider Açıklama :</label>
                            <input type="text" class="form-control" name="virtual_back_content" id="virtual_back_content"  value="{{old('virtual_back_content')}}">
                        </div>
                    </div>
                </div>
